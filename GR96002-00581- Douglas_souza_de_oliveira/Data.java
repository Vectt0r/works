public class Data {
    ...
    // Construtor que inicializa os atributos e verifica se a data é válida
    public Data(int dia, int mes, int ano) 
    {
        if (verificaDataValida(dia, mes, ano)) {
            ...
            System.out.println("Data inválida. Definindo a data para 1/1/2000.");
            this.dia = 1;
            this.mes = 1;
            this.ano = 2000;
        }
    ...
    // Metodo toString para representar a data no formato dia/mês/ano
    @Override
